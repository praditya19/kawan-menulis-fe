      ...
      <b-container fluid="sm">
        <div class="conten_home">
          <div class="conten_home_top">
            ...
            <div class="col-md-6">
              <p>
                3.  Apakah kalimat dibawah ini adalah kalimat yang sesuai dengan kaidah penulisan yang<br> benar?<br>
                <b>Pendidikan kristen haruslah berpusat kepada Kristus.</b>
              </p>
